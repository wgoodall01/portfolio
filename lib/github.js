    ...
    return function(pages, metalsmith, done){
        var promises =
            ...
            .map(function(pageUrl){
                ...
                .then(() => {
					var owner = pages[pageUrl].github.owner;
					var repo  = pages[pageUrl].github.repo;

                    // Get repo data
					console.log(`${pageUrl}: Github fetch: ${owner}/${repo}`);
